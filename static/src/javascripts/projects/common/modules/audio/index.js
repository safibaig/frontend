...
import { Component, React, render } from  '@guardian/dotcom-rendering/packages/guui';
...
class AudioContainer extends Component {
    ...
    render() {
        return (
            <Player sourceUrl={this.props.source} duration={this.props.duration} mediaId={this.props.mediaId} css={cssProps} controls="controls" />
        )
    }
}
...
const init = (): void => {
    ...
    if (placeholder) {
        ...
        render(<AudioContainer source={audioSource} duration={audioDuration} mediaId={audioMediaId}/>, placeholder);
    }
};
